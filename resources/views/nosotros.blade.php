            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <span class="text-xl font-black text-yellow-500">IA GROUPS</span>
                    </div>
                    <p class="text-sm text-gray-400 mb-4 leading-relaxed">
                        Conectando el mundo a través de soluciones logísticas inteligentes y personalizadas.
                    </p>
                </div>

                <!-- Quick Links -->
                <div>
                    <h3 class="text-yellow-500 font-bold text-sm uppercase tracking-wider mb-4">Enlaces Rápidos</h3>
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('home') }}" class="text-gray-400 hover:text-yellow-500 transition-colors">Inicio</a></li>
                        <li><a href="{{ route('nosotros') }}" class="text-gray-400 hover:text-yellow-500 transition-colors">Nosotros</a></li>
                        <li><a href="{{ route('home') }}#servicios" class="text-gray-400 hover:text-yellow-500 transition-colors">Servicios</a></li>
                    </ul>
                </div>

                <!-- Services -->
                <div>
                    <h3 class="text-yellow-500 font-bold text-sm uppercase tracking-wider mb-4">Servicios</h3>
                    <ul class="space-y-2 text-sm">
                        <li><a href="/maritimo" class="text-gray-400 hover:text-yellow-500 transition-colors">Transporte Marítimo</a></li>
                        <li><a href="/aereo" class="text-gray-400 hover:text-yellow-500 transition-colors">Transporte Aéreo</a></li>
                        <li><a href="/terrestre" class="text-gray-400 hover:text-yellow-500 transition-colors">Transporte Terrestre</a></li>
                        <li><a href="/impuestos" class="text-gray-400 hover:text-yellow-500 transition-colors">Gestión Aduanera</a></li>
                    </ul>
                </div>

                <!-- Contact -->
                <div>
                    <h3 class="text-yellow-500 font-bold text-sm uppercase tracking-wider mb-4">Contacto</h3>
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li>Buenos Aires, Argentina</li>
                        <li>+54 11 1234-5678</li>
                        <li>info@iagroups.com</li>
                    </ul>
                </div>
            </div>

            <div class="border-t border-yellow-500/20 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
