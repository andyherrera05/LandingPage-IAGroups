        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden lg:flex space-x-8">
                    <a href="#inicio" class="text-yellow-400 hover:text-yellow-300 font-medium transition-colors">Inicio</a>
                    <a href="{{ route('nosotros') }}" class="text-yellow-400 hover:text-yellow-300 font-medium transition-colors">Nosotros</a>
                    <a href="#servicios" class="text-yellow-400 hover:text-yellow-300 font-medium transition-colors">Servicios</a>
                </nav>
    ...
    <div id="mobileMenu" class="fixed inset-0 bg-black/95 backdrop-blur-lg z-50 lg:hidden hidden">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex flex-col p-6 space-y-6">
                <a href="#inicio" class="text-2xl text-yellow-400 hover:text-yellow-300 font-bold transition-colors mobile-menu-link">Inicio</a>
                ...
                <a href="#servicios" class="text-2xl text-yellow-400 hover:text-yellow-300 font-bold transition-colors mobile-menu-link">Servicios</a>
            </nav>
        </div>
    </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div class="bg-black/40 border border-yellow-500/20 rounded-lg p-3">
                                            ...
                                            <p class="text-lg font-bold text-cyan-400">--</p>
                                        </div>
                                        <div class="bg-black/40 border border-yellow-500/20 rounded-lg p-3">
                                            <p class="text-xs text-gray-500 mb-1">MOQ Mínimo</p>
                                            <p class="text-lg font-bold text-purple-400">--</p>
                                        </div>
                                        <div class="bg-black/40 border border-yellow-500/20 rounded-lg p-3">
                                            <p class="text-xs text-gray-500 mb-1">Dimensiones</p>
                                            <p class="text-sm font-bold text-yellow-400">-- cm</p>
                                        </div>
                                        <div class="bg-black/40 border border-yellow-500/20 rounded-lg p-3">
                                            <p class="text-xs text-gray-500 mb-1">Peso</p>
                                            <p class="text-sm font-bold text-green-400">-- kg</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gradient-to-br from-gray-900/80 via-black/60 to-gray-900/80 border border-yellow-500/30 rounded-xl p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-between items-center pt-2">
                                        ...
                                        <span class="text-3xl font-black bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">$--</span>
                                    </div>
                                </div>
                            </div>
                        </div>
