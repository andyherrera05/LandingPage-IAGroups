<div class="min-h-screen bg-black text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-400 text-lg">Calcula el costo de tus envíos terrestres</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white/5 backdrop-blur-xl border border-yellow-500/30 p-6 rounded-lg hover:border-yellow-500 transition-all">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <button wire:click="$set('tipoCarga', 'lcl')"
                            ...
                            PARCIAL<span class="block text-xs font-normal mt-1 {{ $tipoCarga === 'lcl' ? 'text-black/70' : 'text-gray-500' }}">Carga compartida</span>
                        </button>
                        <button wire:click="$set('tipoCarga', 'fcl')"
                            ...
                            COMPLETO<span class="block text-xs font-normal mt-1 {{ $tipoCarga === 'fcl' ? 'text-black/70' : 'text-gray-500' }}">Camión completo</span>
                        </button>
                        <button wire:click="$set('tipoCarga', 'uld')"
                            ...
                            PALLETS<span class="block text-xs font-normal mt-1 {{ $tipoCarga === 'uld' ? 'text-black/70' : 'text-gray-500' }}">Paletizado</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-yellow-500/30 p-6 rounded-lg hover:border-yellow-500 transition-all">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-yellow-500 font-bold mb-2 text-sm uppercase tracking-wide">Ciudad Origen</label>
                        ...
                        <div>
                            <label class="block text-yellow-500 font-bold mb-2 text-sm uppercase tracking-wide">Ciudad Destino</label>
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-yellow-500/30 p-6 rounded-lg hover:border-yellow-500 transition-all">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-yellow-500 font-bold mb-2 text-sm uppercase tracking-wide">Distancia (km) *</label>
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-yellow-500/30 p-6 rounded-lg hover:border-yellow-500 transition-all">
                    ...
                    <p class="text-gray-500 text-xs mt-2">Para calcular el seguro de la carga</p>
                </div>
        ...
        <div class="mt-8 bg-yellow-500/10 border-l-4 border-yellow-500 p-6 rounded">
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm">Los peajes son estimados. Para cotización final contacta con nuestro equipo comercial.</p>
                </div>
            </div>
        </div>
    </div>
